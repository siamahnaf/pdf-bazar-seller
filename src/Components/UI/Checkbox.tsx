...
const Checkbox = ({ value, onChange, id, label }: Props) => {
    return (
        <div className="flex gap-3 items-center mb-5 mt-3">
            ...
            <label
                htmlFor={id}
                className="select-none text-gray-500 text-base cursor-pointer"
            >
                {label}
            </label>
        </div>
